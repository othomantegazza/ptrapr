...
summarized_panicles %>%  
  ...
  labs(x = "Rank along primary branch",
       ...
       fill = "Spikelet Number per Node",
       caption = "The numbers indicate the average numbers of spikelet on each nodes")
```

Notes:

1. The fill color is the number of spikelet that have that node.
