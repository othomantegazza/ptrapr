...
Place the structure files (`.ricepr`) and their corrispective grain files (`ricegr`) of all the panicles that you want to analyze in one single folder. For every single panicle the name of the `.ricepr` file and the name of the `.ricegr` file must be exaclty the same (obviously beside the extension).
