...
We can see this comparing the graphs. This is the `good_panicle` graph:
...
In order to visualize and inspect primary and secondary branching, we suggest you to represent your data with a dotplot. We have learned about this representation in [this paper by ](). We suggest this plot because it highlights number and position of primary and secondary branches in a direct and intuitive way.
...
By convention panicle graphs have two generating nodes, one at the base of the panicle and one at the top. The function `get_generating()` selects those two nodes
